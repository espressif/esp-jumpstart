...
-  **统一配置规范**：用于将 Wi-Fi 信息安全地传输到设备，与传输模式（SoftAP 或 BLE 模式）无关。请参考 `统一配置相关文档 <https://docs.espressif.com/projects/esp-idf/en/latest/api-reference/provisioning/provisioning.html>`_，查看详细信息。
...
请参考 `统一配置相关文档 <https://docs.espressif.com/projects/esp-idf/en/latest/api-reference/provisioning/provisioning.html>`_，查看详细信息。
...
请参考 `NVS 相关文档 <https://docs.espressif.com/projects/esp-idf/en/latest/api-reference/storage/nvs_flash.html>`_，查看详细信息.
