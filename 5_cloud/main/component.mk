...
COMPONENT_EMBED_TXTFILES := cloud_cfg/server.cert cloud_cfg/device.cert cloud_cfg/device.key cloud_cfg/deviceid.txt cloud_cfg/endpoint.txt

ifndef IDF_CI_BUILD
# Print an error if the certificate/key files are missing
$(COMPONENT_PATH)/cloud_cfg/server.cert $(COMPONENT_PATH)/cloud_cfg/device.cert $(COMPONENT_PATH)/cloud_cfg/device.key $(COMPONENT_PATH)/cloud_cfg/deviceid.txt $(COMPONENT_PATH)/cloud_cfg/endpoint.txt:
